...
class JSONModeOutputParser:
    ...
    def _parse_item(
        ...
        effect_class: EffectClass = effect_class_raw  # type: ignore[assignment]  # expiry_wave: Wave 30
        ...
        if interaction_target_raw in _VALID_INTERACTION_TARGETS:
            interaction_target = interaction_target_raw  # type: ignore[assignment]  # expiry_wave: Wave 30

...
class PlannedRecoveryGateService(RecoveryGateService):
    ...
    def _emit_recovery(self, run_id: str, reason_code: str, mode: str) -> None:
        ...
        if self._observability_hook is None:
            return
        with contextlib.suppress(Exception):  # rule7-exempt: observability hook must not block recovery gate  # noqa: E501  # expiry_wave: Wave 26  # added: W25 baseline sweep

...
class ReasoningLoop:
    ...
    async def run_once(
        ...
        if self._observability_hook is not None:
            with contextlib.suppress(Exception):  # rule7-exempt: observability hook must not block inference path  # noqa: E501  # expiry_wave: Wave 26  # added: W25 baseline sweep

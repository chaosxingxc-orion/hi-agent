...
class RetryingExecutorService:
    ...
    async def execute(self, action: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                if attempt < self._max_attempts - 1:
                    ...
                    if (
                        ...
                        with contextlib.suppress(Exception):  # rule7-exempt: observability hook must not block retry executor  # noqa: E501  # expiry_wave: Wave 28  # added: W25 baseline sweep
        ...
        raise last_exc  # type: ignore[misc]  # expiry_wave: Wave 28

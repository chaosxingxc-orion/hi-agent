...
try:
    ...
    _otel_trace = None  # type: ignore[assignment]  # expiry_wave: permanent
    _NonRecordingSpan = None  # type: ignore[assignment,misc]  # expiry_wave: permanent
    _PROPAGATOR = None  # type: ignore[assignment]  # expiry_wave: permanent
...
try:
    from opentelemetry import (
        metrics as _otel_metrics,  # type: ignore[attr-defined]  # expiry_wave: permanent
    )

    _OTEL_METRICS_AVAILABLE = True
except ImportError:  # pragma: no cover
    _OTEL_METRICS_AVAILABLE = False
    _otel_metrics = None  # type: ignore[assignment]  # expiry_wave: permanent

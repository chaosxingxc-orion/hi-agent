...
def sqlite_lock_contention_health_check(
    ...
    def _check() -> tuple[HealthStatus, str]:
        ...
        try:
            ...
            with contextlib.suppress(Exception):  # rule7-exempt: SQLite ROLLBACK in health check error path; must not mask original exception  # noqa: E501  # expiry_wave: Wave 27  # added: W25 baseline sweep

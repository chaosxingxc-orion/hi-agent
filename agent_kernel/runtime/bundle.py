...
class AgentKernelRuntimeBundle:
    ...
    def build_minimal_complete(
        ...
        """
        resolved_event_log_config = event_log_config if event_log_config is not None else RuntimeEventLogConfig()  # noqa: E501  # expiry_wave: Wave 26  # added: W25 baseline sweep
        resolved_dedupe_config = dedupe_config if dedupe_config is not None else RuntimeDedupeConfig()  # noqa: E501  # expiry_wave: Wave 26  # added: W25 baseline sweep
        resolved_decision_deduper_config = decision_deduper_config if decision_deduper_config is not None else RuntimeDecisionDedupeConfig()  # noqa: E501  # expiry_wave: Wave 26  # added: W25 baseline sweep
        resolved_recovery_config = recovery_outcome_config if recovery_outcome_config is not None else RuntimeRecoveryOutcomeConfig()  # noqa: E501  # expiry_wave: Wave 26  # added: W25 baseline sweep
        resolved_turn_intent_config = turn_intent_log_config if turn_intent_log_config is not None else RuntimeTurnIntentLogConfig()  # noqa: E501  # expiry_wave: Wave 26  # added: W25 baseline sweep
        resolved_production_safety = production_safety_config if production_safety_config is not None else RuntimeProductionSafetyConfig()  # noqa: E501  # expiry_wave: Wave 26  # added: W25 baseline sweep
        ...
        return cls(
            ...
            strict_mode_config=(strict_mode_config if strict_mode_config is not None else RuntimeStrictModeConfig()),  # noqa: E501  # expiry_wave: Wave 26  # added: W25 baseline sweep
    ...
    def _build_kernel_core(
        ...
        recovery_outcomes = AgentKernelRuntimeBundle._build_recovery_outcomes(
            recovery_outcome_config if recovery_outcome_config is not None else RuntimeRecoveryOutcomeConfig(),  # noqa: E501  # expiry_wave: Wave 26  # added: W25 baseline sweep
        )
        turn_intent_log = AgentKernelRuntimeBundle._build_turn_intent_log(
            turn_intent_log_config if turn_intent_log_config is not None else RuntimeTurnIntentLogConfig(),  # noqa: E501  # expiry_wave: Wave 26  # added: W25 baseline sweep
        )
        ...
        resolved_deduper_config = decision_deduper_config if decision_deduper_config is not None else RuntimeDecisionDedupeConfig()  # noqa: E501  # expiry_wave: Wave 26  # added: W25 baseline sweep
        deduper: DecisionDeduper

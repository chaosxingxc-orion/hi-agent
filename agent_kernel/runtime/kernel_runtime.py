        ...
        *,
        ...
        def _worker_health_check() -> tuple[HealthStatus, str]:
            ...
            if adaptor.worker_failed:
                with contextlib.suppress(Exception):  # rule7-exempt: worker health check probe; must not block health endpoint  # noqa: E501  # expiry_wave: Wave 29  # added: W25 baseline sweep

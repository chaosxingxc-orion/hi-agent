...
def create_app_temporal(
    ...
    @asynccontextmanager
    async def _lifespan(app: Starlette):  # type: ignore[type-arg]  # expiry_wave: Wave 27
    ...
    return ApiKeyMiddleware(inner, api_key=config.api_key)  # type: ignore[return-value]  # expiry_wave: Wave 27

...
class TemporalAdaptor:
    ...
    async def stop(self) -> None:
        ...
        if self._env is not None:
            ...
            with contextlib.suppress(Exception):  # rule7-exempt: Temporal dev-server shutdown; best-effort teardown  # noqa: E501  # expiry_wave: permanent  # added: W25 baseline sweep
    ...
    def check_worker(self) -> None:
        ...
        if self.worker_failed:
            raise self._worker_task.exception()  # type: ignore[misc]  # expiry_wave: permanent
    ...
    def _on_worker_done(self, task: asyncio.Task[Any]) -> None:
        ...
        for cb in self._worker_done_callbacks:
            with contextlib.suppress(Exception):  # rule7-exempt: worker done callback must not block shutdown  # noqa: E501  # expiry_wave: permanent  # added: W25 baseline sweep
                cb(task)

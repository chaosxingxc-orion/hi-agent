...
def ensure_vendored_source() -> None:
    ...
    with _LOCK:
        ...
        _pkg.__path__ = [vendor_abs, *installed_paths]  # type: ignore[assignment]  # expiry_wave: Wave 29
        ...
        try:
            ...
            _bridge.__path__ = [vendor_bridge, *installed_bridge]  # type: ignore[assignment]  # expiry_wave: Wave 29
        except ImportError:  # rule7-exempt: expiry_wave="Wave 29" replacement_test: wave22-tests
            pass

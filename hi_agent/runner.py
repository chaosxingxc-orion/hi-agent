...
def _set_engine_context_provider(engine: object, provider: object) -> None:
    ...
    if hasattr(engine, "set_context_provider"):
        engine.set_context_provider(provider)  # type: ignore[union-attr]  expiry_wave: Wave 28
    elif hasattr(engine, "_context_provider"):
        engine._context_provider = provider  # type: ignore[union-attr]  expiry_wave: Wave 28
...
class RunExecutor:
    ...
    def dispatch_subrun(
        ...
        try:
            ...
            self._pending_subrun_futures[task_id] = future  # type: ignore[attr-defined]  expiry_wave: Wave 28
        except RuntimeError:
            ...
            self._completed_subrun_results[task_id] = results[0]  # type: ignore[attr-defined]  expiry_wave: Wave 28

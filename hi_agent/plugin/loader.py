...
from hi_agent.plugins.loader import *  # noqa: F403  expiry_wave: Wave 28
from hi_agent.plugins.loader import (
    PluginLoader,  # noqa: F401  expiry_wave: Wave 28  # scope: legacy-compatibility — re-export shim for backward compat; removed in Wave 27
)

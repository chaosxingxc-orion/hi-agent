...
from hi_agent.plugins.manifest import *  # noqa: F403  expiry_wave: Wave 29
from hi_agent.plugins.manifest import (
    PluginManifest,  # noqa: F401  expiry_wave: Wave 29  # scope: legacy-compatibility — re-export shim for backward compat
)

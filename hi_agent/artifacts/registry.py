...
class ArtifactRegistry:
    ...
    def create(
        ...
        **kwargs: object,
        ...
        artifact = Artifact(artifact_type=artifact_type, **kwargs)  # type: ignore[arg-type]  expiry_wave: Wave 30  # scope: complex-union-resolution — **kwargs spread over optional fields; mypy can't verify complete coverage

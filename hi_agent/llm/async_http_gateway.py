...
class AsyncHTTPGateway:
    ...
    def __init__(
        ...
        self._inner = HTTPGateway(
            ...
            failover_chain=failover_chain,  # type: ignore[arg-type]  expiry_wave: Wave 29
            cache_injector=cache_injector,  # type: ignore[arg-type]  expiry_wave: Wave 29  # scope: third-party-stub-gap — Optional[PromptCacheInjector] vs None union
            budget_tracker=budget_tracker,  # type: ignore[arg-type]  expiry_wave: Wave 29
        )

    ...
    *same* event loop, so async resources (``httpx.AsyncClient`` pools, async
    ...
    def _run(self) -> None:
        ...
        try:
            ...
            try:
                ...
                with contextlib.suppress(Exception):  # rule7-exempt: expiry_wave="permanent" asyncgen teardown on loop close  # noqa: E501
    ...
    def call_sync(
        ...
        *,
        ...
        with contextlib.suppress(Exception):  # rule7-exempt: spine emitters must never block execution path  # noqa: E501  # expiry_wave: permanent

                ...
                if _dp and _api_key.strip():
                    ...
                    if gw is not None:
                        with self._lock:
                            ...
                            self._llm_gateway = gw  # type: ignore[assignment]  expiry_wave: Wave 27
                            ...
                            if self._tier_router is None and hasattr(gw, "_tier_router"):
                                self._tier_router = gw._tier_router  # type: ignore[union-attr]  expiry_wave: Wave 27
                        _logger.info(
            ...
            for provider in provider_order:
                ...
                if os.environ.get(env_var):
                    ...
                    if provider == "anthropic":
                        from hi_agent.llm.protocol import LLMGateway  # noqa: F401  expiry_wave: Wave 27
                    ...
                    self._llm_gateway = TierAwareLLMGateway(raw_gateway, tier_router, registry)  # type: ignore[assignment]  expiry_wave: Wave 27
                    return self._llm_gateway

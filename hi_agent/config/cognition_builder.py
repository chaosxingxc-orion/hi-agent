                ...
                if _dp and _api_key.strip():
                    ...
                    if gw is not None:
                        with self._lock:
                            ...
                            self._llm_gateway = gw  # type: ignore[assignment]  expiry_wave: Wave 17
                            ...
                            if self._tier_router is None and hasattr(gw, "_tier_router"):
                                self._tier_router = gw._tier_router  # type: ignore[union-attr]  expiry_wave: Wave 17
                        _logger.info(
        ...
        with self._lock:
            ...
            for provider in provider_order:
                ...
                if os.environ.get(env_var):
                    ...
                    self._llm_gateway = TierAwareLLMGateway(raw_gateway, tier_router, registry)  # type: ignore[assignment]  expiry_wave: Wave 17
                    return self._llm_gateway

    ...
    def _invoke_capability_via_hooks(self, proposal: object, payload: dict) -> dict:
        ...
        try:
            ...
            def _call_fn(_ctx: ToolCallContext) -> str:
                ...
                _call_fn._last_result = result  # type: ignore[attr-defined]  expiry_wave: Wave 27
                return str(result.get("success", False))

            _call_fn._last_result = {}  # type: ignore[attr-defined]  expiry_wave: Wave 27
            ...
            _HOOK_TIMEOUT = 120.0  # noqa: N806 — module-level constant semantics  expiry_wave: Wave 27
            get_bridge().call_sync(
                self._ctx.hook_manager.wrap_tool_call(tool_ctx, _call_fn),
                timeout=_HOOK_TIMEOUT,
            )

            return _call_fn._last_result  # type: ignore[attr-defined]  expiry_wave: Wave 27

...
"""
    ...
    def _migrate(self) -> None:
        ...
        if "project_id" not in cols:
            cx.execute(
                "ALTER TABLE idempotency_records ADD COLUMN project_id TEXT NOT NULL DEFAULT ''"  # migration compat: legacy rows get empty string  # noqa: E501  # expiry_wave: Wave 27
            )

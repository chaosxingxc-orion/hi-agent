...
def build_durable_backends(
    ...
    from hi_agent.memory.l1_store import (
        L1CompressedMemoryStore,  # noqa: F401  # wired via SystemBuilder # expiry_wave: Wave 27
    )
    from hi_agent.memory.l2_store import (
        L2RunMemoryIndexStore,  # noqa: F401  # wired via SystemBuilder # expiry_wave: Wave 27
    )

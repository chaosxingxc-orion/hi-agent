...
async def handle_ready(request: Request) -> JSONResponse:
    ...
    try:
        ...
        _auth_rdy = _AM_rdy(app=lambda *a: None, runtime_mode=_runtime_mode_rdy)  # type: ignore[arg-type]  expiry_wave: Wave 30 replacement_test: tests/unit/test_server_app_rule7.py::test_probe_exempt
...
def build_app(agent_server: AgentServer) -> Starlette:
    ...
    async def lifespan(app: Starlette):  # type: ignore[misc]  expiry_wave: Wave 30 replacement_test: tests/unit/test_server_app_rule7.py::test_probe_exempt
    ...
    _auth_posture_mw = AuthMiddleware(app=lambda *a: None, runtime_mode=_runtime_mode_auth)  # type: ignore[arg-type]  expiry_wave: Wave 30 replacement_test: tests/unit/test_server_app_rule7.py::test_probe_exempt
    ...
    app.add_exception_handler(HTTPException, http_exception_handler)  # type: ignore[arg-type]  expiry_wave: Wave 30 replacement_test: tests/unit/test_server_app_rule7.py::test_probe_exempt
    app.add_exception_handler(404, http_exception_handler)  # type: ignore[arg-type]  expiry_wave: Wave 30 replacement_test: tests/unit/test_server_app_rule7.py::test_probe_exempt
    app.add_exception_handler(405, http_exception_handler)  # type: ignore[arg-type]  expiry_wave: Wave 30 replacement_test: tests/unit/test_server_app_rule7.py::test_probe_exempt

...
This is the canonical implementation in hi_agent.plugins (plural).
hi_agent.plugin.manifest is a deprecated compatibility shim.
...
class PluginManifest(ExtensionManifestMixin):
    ...
    # ExtensionManifest Protocol fields

...
class MemoryCompressor:
    ...
    async def _gateway_compress(
        ...
        response = await loop.run_in_executor(
            ...
            request,  # type: ignore[union-attr]  expiry_wave: Wave 27
        )
    ...
    def _gateway_compress_sync(
        ...
        response = self._gateway.complete(request)  # type: ignore[union-attr]  expiry_wave: Wave 27
        parsed = json.loads(response.content)
    ...
    async def _llm_compress(
        ...
        raw_response = await self.llm_fn(prompt)  # type: ignore[misc]  expiry_wave: Wave 27

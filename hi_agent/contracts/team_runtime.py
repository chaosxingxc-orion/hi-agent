    ...
    def __post_init__(self) -> None:
        if self.hypotheses and not self.working_set:
            warnings.warn(
                ...
                "hypotheses will be removed in Wave 23.",
                DeprecationWarning,
                stacklevel=2,
            )
        ...
        if self.claims and not self.assertions:
            warnings.warn(
                ...
                "claims will be removed in Wave 23.",
                DeprecationWarning,
                stacklevel=2,
            )
...
class TeamRun:
    ...
    user_id: str = ""
    session_id: str = ""
    # Deprecated: use lead_run_id instead. Will be removed in Wave 23.
    pi_run_id: str = ""

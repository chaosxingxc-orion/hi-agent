...
class TeamSharedContext:
    ...
    # Retained for backward compatibility; new callers must NOT set these.
    ...
    def __post_init__(self) -> None:
        if self.hypotheses and not self.working_set:
            warnings.warn(
                ...
                "The legacy alias is mapped to working_set for backward compatibility.",
                DeprecationWarning,
                stacklevel=2,
            )
        ...
        if self.claims and not self.assertions:
            warnings.warn(
                ...
                "The legacy alias is mapped to assertions for backward compatibility.",
                DeprecationWarning,
                stacklevel=2,
            )
...
class TeamRun:
    ...
    user_id: str = ""
    session_id: str = ""
    # Deprecated: use lead_run_id instead. Retained for backward compatibility.
    pi_run_id: str = ""

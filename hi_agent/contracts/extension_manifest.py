...
class ExtensionManifest(Protocol):
    ...
    Enforcement fields:
        required_posture: Minimum posture required to enable this extension.
            "any" | "dev" | "strict" | "prod"  ("research" is deprecated; Wave 14 removal)
    ...
    # -- Enforcement fields --
    required_posture: str  # "any" | "dev" | "strict" | "prod"  ("research" deprecated Wave 14)
...
class ExtensionManifestMixin:
    ...
    def production_eligibility(self, posture: Posture) -> tuple[bool, list[str]]:
        ...
        if rp == "research":
            warnings.warn(
                "required_posture='research' is deprecated and will be removed in Wave 14. "
                "Use 'strict' instead.",
                DeprecationWarning,
                stacklevel=2,
            )

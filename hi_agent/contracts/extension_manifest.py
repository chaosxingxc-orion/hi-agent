...
class ExtensionRequiresHumanApproval(ExtensionDisallowedError):  # noqa: N818  expiry_wave: Wave 26
...
class ExtensionTenantScopeRequired(ExtensionDisallowedError):  # noqa: N818  expiry_wave: Wave 26
...
class ExtensionManifest(Protocol):
    ...
    Enforcement fields:
        required_posture: Minimum posture required to enable this extension.
            "any" | "dev" | "strict" | "prod"  ("research" is deprecated; Wave 27 removal)
    ...
    # -- Enforcement fields --
    required_posture: str  # "any" | "dev" | "strict" | "prod"  ("research" deprecated Wave 27)
...
class ExtensionManifestMixin:
    ...
    def production_eligibility(self, posture: Posture) -> tuple[bool, list[str]]:
        ...
        if rp == "research":
            warnings.warn(
                "required_posture='research' is deprecated and will be removed in Wave 27. "
                "Use 'strict' instead.",
                DeprecationWarning,
                stacklevel=2,
            )
...
class ExtensionRegistry:
    ...
    def enable(self, name: str, version: str, posture: Posture | None = None, *, tenant_id: str = "") -> None:  # noqa: E501  expiry_wave: Wave 26

...
def make_ctx(**overrides):
    defaults = {
        ...
        "skill_ids_used": [],
        "pending_subrun_futures": {},
        "completed_subrun_results": {},
        "capability_provenance_store": {},
        "emit_observability_fn": None,
        "persist_snapshot_fn": None,
        "finalize_skill_outcomes_fn": None,
        "sync_to_context_fn": None,
        "env": "dev",
        "readiness_snapshot": {},
        "mcp_status": {},
        "kernel": MagicMock(mode="local-fsm"),
        "stages": [],
        "dag": None,
        "action_seq": None,

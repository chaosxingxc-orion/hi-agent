...
def test_canonical_ops_import():
    ...
    import hi_agent.operations  # noqa: F401  expiry_wave: Wave 17
...
def test_deprecated_experiment_import_warns():
    ...
    with warnings.catch_warnings(record=True) as caught:
        ...
        import hi_agent.experiment  # noqa: F401  expiry_wave: Wave 17
...
def test_longrunningopstore_accessible_via_operations():
    ...
    from hi_agent.operations.op_store import LongRunningOpStore  # noqa: F401  expiry_wave: Wave 17

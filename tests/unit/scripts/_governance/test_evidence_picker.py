...
class TestLatestEvidence:
    ...
    def test_pattern_filters_correctly(self, tmp_path: Path) -> None:
        ...
        _write_evidence(tmp_path, "bbb2", "operator-drill", generated_at="2026-04-28T11:00:00+00:00")  # noqa: E501  # expiry_wave: Wave 27
...
class TestEvidenceForSha:
    ...
    def test_does_not_call_git(self, tmp_path: Path, monkeypatch) -> None:
        ...
        def reject_git(args, *a, **kw):
            if args and (args[0] == "git" or (isinstance(args[0], str) and "git" in args[0].lower())):  # noqa: E501  # expiry_wave: Wave 27

"""Tests for G-12: TaskContract.stage_goal + exit_criterion; GateCoordinator.check_exit_criterion()."""
import json
...
def _make_contract(**kwargs):
    ...
    defaults = {"task_id": "test-id", "goal": "test", "task_family": "research", "risk_level": "low"}
...
def test_metric_threshold_criterion_satisfied(tmp_path):
    ...
    c = _make_contract(exit_criterion={
        ...
        "params": {"metric_file": "metrics.json", "key": "accuracy", "threshold": 0.9, "op": ">="}
    })

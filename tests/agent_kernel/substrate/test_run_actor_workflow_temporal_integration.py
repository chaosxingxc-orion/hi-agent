...
async def test_real_run_actor_workflow_runs_signal_and_query_in_temporal_test_env() -> None:
    ...
    assert UnsandboxedWorkflowRunner is not None, "Expected non-None result for UnsandboxedWorkflowRunner"  # noqa: E501  # expiry_wave: Wave 18
...
async def test_child_completion_signal_updates_parent_active_child_runs_in_temporal_env() -> None:
    ...
    async with await WorkflowEnvironment.start_time_skipping() as env:
        ...
        async with Worker(
            ...
            assert completed_projection is not None, "Expected non-None result for completed_projection"  # noqa: E501  # expiry_wave: Wave 18

...
class TestReflectionExhaustionEscalation:
    ...
    def test_fallback_decision_escalates_when_escalate_on_exhaustion_true(self) -> None:
        ...
        decision = gate._fallback_decision(recovery_input, "test:reason")  # type: ignore[attr-defined]  expiry_wave: Wave 17
    ...
    def test_should_reflect_false_when_rounds_exhausted(self) -> None:
        ...
        gate = PlannedRecoveryGateService(
            ...
            reasoning_loop=_StubLoop(),  # type: ignore[arg-type]  expiry_wave: Wave 17
        ...
        result = gate._should_reflect(recovery_input, "abort")  # type: ignore[attr-defined]  expiry_wave: Wave 17

...
def _app_with_plugin_loader(monkeypatch):
    ...
    monkeypatch.setattr(_routes_manifest, "require_tenant_context", lambda: None)  # B1: SUT-internal mock — schedule replacement with boundary mock  # noqa: E501  # expiry_wave: Wave 27

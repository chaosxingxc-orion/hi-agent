...
class TestTierAwareLLMGatewaySkillConfidence:
    def _make_gateway(self) -> object:
        ...
        gw._selected_models = selected_models  # type: ignore[attr-defined]  expiry_wave: Wave 26
        return gw
    ...
    def test_gateway_reads_skill_confidence_from_metadata(self) -> None:
        ...
        assert gw._selected_models[-1] == "light-1"  # type: ignore[attr-defined]  expiry_wave: Wave 26
    ...
    def test_gateway_ignores_low_skill_confidence(self) -> None:
        ...
        assert gw._selected_models[-1] == "medium-1"  # type: ignore[attr-defined]  expiry_wave: Wave 26

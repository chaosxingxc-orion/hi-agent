...
class TestSystemBuilder:
    def test_builds_all_memory_stores(self, tmp_path):
        ...
        assert short is not None, "Expected non-None result for short"
        assert mid is not None, "Expected non-None result for mid"
        assert graph is not None, "Expected non-None result for graph"
        assert retrieval is not None, "Expected non-None result for retrieval"
        assert mgr is not None, "Expected non-None result for mgr"
...
class TestFullLifecycle:
    def test_stm_to_dream_to_consolidation(self, tmp_path):
        ...
        assert summary is not None, "Expected non-None result for summary"

...
def test_recovery_passes_real_attempt_history(tmp_path: Any, monkeypatch: Any) -> None:
    ...
    bridge.build_context = _spy_build  # type: ignore[method-assign]  expiry_wave: Wave 26
    ...
    executor._get_attempt_history = _recording_get_attempt_history  # type: ignore[method-assign]  expiry_wave: Wave 26

...
class TestSeqRestore:
    ...
    def test_action_seq_restored(self) -> None:
        ...
        try:
            ...
            with patch.object(RunExecutor, "_execute_remaining", patched):  # B1: SUT-internal mock — schedule replacement with boundary mock  # noqa: E501  # expiry_wave: permanent
                RunExecutor.resume_from_checkpoint(
                path,
                kernel,
                raw_memory=RawMemoryStore(),
...
class TestCLIResume:
    ...
    def test_resume_with_checkpoint_file(self) -> None:
        ...
        try:
            ...
            _orig_resume = _RunExecutor.resume_from_checkpoint.__func__  # type: ignore[attr-defined]  expiry_wave: permanent

            def _patched_resume(cls, cp_path, kernel, **kwargs):  # type: ignore[no-untyped-def]  expiry_wave: permanent

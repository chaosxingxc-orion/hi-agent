...
def _make_executor_with_stub(
    ...
    *,
    ...
    executor._execute_stage = stub_execute_stage  # type: ignore[assignment]  expiry_wave: Wave 27
...
class TestExecuteGraphMaxStepsSafety:
    ...
    def test_max_steps_prevents_runaway(self) -> None:
        ...
        executor._execute_stage = always_succeed  # type: ignore[assignment]  expiry_wave: Wave 27

...
class TestRunManagerQueue:
    ...
    def test_queue_full_rejects(self) -> None:
        ...
        errors = {rid: mgr.get_run(rid).error for rid in ids}  # type: ignore[union-attr]  expiry_wave: Wave 26
    ...
    def test_queued_run_eventually_executes(self) -> None:
        ...
        assert mgr.get_run(rid1).state == "completed"  # type: ignore[union-attr]  expiry_wave: Wave 26
...
class TestSSEStreaming:
    ...
    def test_sse_endpoint_exists(self, client: TestClient) -> None:
        ...
        app = client.app
        route_paths = []
        for route in app.routes:  # type: ignore[union-attr]  expiry_wave: Wave 26

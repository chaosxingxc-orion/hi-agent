...
def test_l0_file_is_flushed_before_summarizer_reads_it(
    ...
    monkeypatch.setattr(_l0_mod.L0Summarizer, "summarize_run", _observing_summarize)  # B1: SUT-internal mock — schedule replacement with boundary mock  # noqa: E501  # expiry_wave: Wave 26

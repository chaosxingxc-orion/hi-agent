...
import pytest
import pytest_asyncio  # noqa: F401 - ensures the plugin is imported  expiry_wave: permanent
...
def _sample_summary(
    ...
    modified_files: list[str] | None = _SENTINEL,  # type: ignore[assignment]  expiry_wave: permanent
    next_steps: str = "Do B",
    ...
    return StructuredSummary(
        ...
        progress=progress,
        decisions=decisions,
        modified_files=list(modified_files),  # type: ignore[arg-type]  expiry_wave: permanent

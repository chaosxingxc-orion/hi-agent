...
**Manifest:** `docs/releases/platform-release-manifest-2026-05-02-9db23868.json`
Functional HEAD: 9db238683aba39434279ee5c982bd9eedd87da5a
...
- **Gate evidence:** `docs/verification/975a8b0-arch-7x24.json` shows 5/5 PASS at HEAD; manifest 2026-05-02-9db23868 shows `seven_by_twenty_four_operational_readiness=94.55` with `cap_factors_7x24=[]`.

...
- **Gate evidence:** `docs/verification/975a8b0-arch-7x24.json` shows 5/5 PASS at HEAD; manifest 2026-05-02-1dc24913 shows `seven_by_twenty_four_operational_readiness=94.55` with `cap_factors_7x24=[]`.

...
**Manifest:** `docs/releases/platform-release-manifest-2026-05-02-32ce75c9.json`
Functional HEAD: 32ce75c9ac3045279f8e387e708853fa669a11b0
...
- **Gate evidence:** `docs/verification/975a8b0-arch-7x24.json` shows 5/5 PASS at HEAD; manifest 2026-05-02-32ce75c9 shows `seven_by_twenty_four_operational_readiness=94.55` with `cap_factors_7x24=[]`.

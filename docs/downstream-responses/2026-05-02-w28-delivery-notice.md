...
**Manifest:** `docs/releases/platform-release-manifest-2026-05-02-afecfaea.json`
Functional HEAD: afecfaea7a248fad6feff1802d8306c02973991d
...
- **Gate evidence:** `docs/verification/975a8b0-arch-7x24.json` shows 5/5 PASS at HEAD; manifest 2026-05-02-afecfaea shows `seven_by_twenty_four_operational_readiness=94.55` with `cap_factors_7x24=[]`.

...
**Wave:** 35
**Status:** SHIP
**Manifest:** `2026-05-05-bd4d38d5` (built at HEAD `bd4d38d5`)
Functional HEAD: bd4d38d5a77fd4e4e2c053606094b8055b937d86
...
| Default-offline clean-env at HEAD | PASS | `docs/verification/d767fde0-default-offline-clean-env.json` (to be filled in by release-captain) — 9288 passed / 8 skipped / 0 failed (2:54 wall-clock) | measured | RIA standard |
...
| Real T3 (Volces) at HEAD | PASS | `docs/delivery/2026-05-05-d767fde0-t3-volces.json` — Volces re-run scheduled for closure-notice attachment; deferred to release-captain run because W35 lands hot-path code (run_manager.py, app.py, idempotency.py) per Rule 8 T3 invariance | pending | RIA standard |
| arch-7×24 fresh evidence | PASS | `docs/verification/d767fde-arch-7x24.json` 5/5 PASS at the W35 HEAD — to be regenerated by release-captain agent | pending | RIA standard |
...
- Manifest (pending): `docs/releases/platform-release-manifest-2026-05-05-bd4d38d5.json`
...
**Audit head:** docs match hi-agent main at 2026-05-05, manifest release_head `bd4d38d5a77fd4e4e2c053606094b8055b937d86`

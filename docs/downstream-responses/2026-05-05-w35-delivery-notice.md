...
| Default-offline clean-env at HEAD | PASS | `docs/verification/8ae5314a-default-offline-clean-env.json` (to be filled in by release-captain) — 9288 passed / 8 skipped / 0 failed (2:54 wall-clock) | measured | RIA standard |
...
| Real T3 (Volces) at HEAD | PASS | `docs/delivery/2026-05-05-8ae5314a-t3-volces.json` — Volces re-run scheduled for closure-notice attachment; deferred to release-captain run because W35 lands hot-path code (run_manager.py, app.py, idempotency.py) per Rule 8 T3 invariance | pending | RIA standard |
| arch-7×24 fresh evidence | PASS | `docs/verification/8ae5314-arch-7x24.json` 5/5 PASS at the W35 HEAD — to be regenerated by release-captain agent | pending | RIA standard |
...
- Manifest (pending): `docs/releases/platform-release-manifest-2026-05-05-24cfa0a6.json`
...
**Audit head:** docs match hi-agent main at 2026-05-05, manifest release_head `24cfa0a67249d9824f9ecd39f60764a548fe2699`

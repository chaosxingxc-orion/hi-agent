# Wave {{WAVE}} — Vocabulary Debt Clearance + Stable 80 Baseline
...
- `docs/verification/{{HEAD_SHORT}}-default-offline-clean-env.json` — clean-env evidence
- `docs/verification/{{HEAD_SHORT}}-observability-spine.json` — spine evidence (structural)

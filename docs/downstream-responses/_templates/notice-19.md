# Wave {{WAVE}} — Scope-Aware Governance + Class-Pure Closure (80 → 86)
...
|---|---|---|---|
| `current_verified_readiness` | 80.0 | {{SCORE_CAP}} | scope-aware cap fix; engineering gates resolved |
...
## Evidence Index (at {{HEAD}})

- `docs/releases/{{MANIFEST_ID}}.json` — release manifest
...
- `docs/verification/{{HEAD_SHORT}}-observability-spine.json` — spine evidence

...
class IdempotencyMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next):  # type: ignore[override]  # expiry_wave: Wave 26
        ...
        request._body = body_bytes  # type: ignore[attr-defined]  # expiry_wave: Wave 26
...
async def _capture_response_body(response: Response) -> bytes:
    ...
    chunks: list[bytes] = []
    async for chunk in response.body_iterator:  # type: ignore[attr-defined]  # expiry_wave: Wave 26

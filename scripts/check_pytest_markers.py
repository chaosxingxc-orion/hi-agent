...
try:
    ...
    try:
        import tomli as tomllib  # type: ignore[no-redef]  # expiry_wave: Wave 30
    except ImportError:
        tomllib = None  # type: ignore[assignment]  # expiry_wave: Wave 30
...
def main() -> int:
    ...
    result: dict = {
        ...
        "unregistered_markers": {k: v for k, v in unregistered.items()},  # noqa: C416  # expiry_wave: Wave 30  # added: W25 baseline sweep

...
def main() -> int:
    ...
    if manifest_filename_sha and manifest_head and not _sha_match(manifest_filename_sha, manifest_head):  # noqa: E501  # expiry_wave: permanent  # added: W25 baseline sweep
        violations.append(

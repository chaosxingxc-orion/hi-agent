...
NO_SCOPE_ALLOWLIST: dict[str, AllowlistEntry] = {
    ...
    "handle_knowledge_status": AllowlistEntry(
        reason="Knowledge status 鈥?system-wide KG stats; global readonly; no per-tenant node data exposed",
    ...
    "handle_knowledge_lint": AllowlistEntry(
        reason="Knowledge lint 鈥?stateless validation; global readonly; no stored per-tenant data access",
    ...
    "handle_skills_list": AllowlistEntry(
        reason="Skills listing 鈥?global registry; global readonly; all tenants see same skills list",
    ...
    "handle_skills_status": AllowlistEntry(
        reason="Skills status 鈥?system-wide skill health; global readonly; no per-tenant data exposed",
    ...
    "handle_skill_metrics": AllowlistEntry(
        reason="Skill metrics 鈥?aggregate counters; global readonly; no per-tenant data in current implementation",
    ...
    "handle_skill_versions": AllowlistEntry(
        reason="Skill versions 鈥?global version history; global readonly; no per-tenant version data",
    ...
    "handle_tools_list": AllowlistEntry(
        reason="Tool listing 鈥?global registry; global readonly; no secret per-tenant tools in current impl",
    ...
    "handle_mcp_tools": AllowlistEntry(
        reason="MCP tools root handler 鈥?global registry; global readonly; no per-tenant data in tool server listing",
    ...
    "handle_mcp_tools_list": AllowlistEntry(
        reason="MCP tool listing 鈥?global registry; global readonly; same contract as handle_tools_list",

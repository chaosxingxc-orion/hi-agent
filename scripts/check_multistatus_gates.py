...
def main() -> int:
    ...
    result = {
        ...
        "reason": "multi-status adoption in progress; not_applicable conversion pending" if single_path_gates else "",  # noqa: E501  # expiry_wave: permanent  # added: W25 baseline sweep
    }
    ...
    if args.json:
        ...
        if single_path_gates:
            print(f"DEFERRED: {len(single_path_gates)} gates still single-path (conversion pending)", file=sys.stderr)  # noqa: E501  # expiry_wave: permanent  # added: W25 baseline sweep
        else:
